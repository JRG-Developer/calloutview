...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    SMMapAnnotation *capeCanaveral = [SMMapAnnotation new];
    ...
    bottomMapView = [[SMMapView alloc] initWithFrame:CGRectOffset(half, 0, half.size.height)];
