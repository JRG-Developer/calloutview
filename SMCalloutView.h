...
/**
 * Returns the custom title view (if specified) or default title label.
 */

@property (nonatomic, readonly) UIView *titleViewOrDefault;

/**
 * Returns the default title label.
 */

@property (nonatomic, readonly) UILabel *titleLabel;

/**
 * Returns the custom subtitle view (if specified) or the default title label.
 */

@property (nonatomic, readonly) UIView *subtitleViewOrDefault;

/**
 * Returns the default subtitle label.
 */
